export class Nivel5 extends Phaser.Scene {
    constructor() {
        super({ key: 'nivel5' });
        this.jugador = null;
        this.cursors = null;
    ...
    create() {
        ...
        crearPajaro(850, filas[0].y - 50, -100);
        crearPajaro(899, filas[0].y - 50, -100);
        crearPajaro(400, filas[0].y - 50, -100);
        crearPajaro(350, filas[0].y - 50, -100);
        ...
        crearPez(-10, filas[0].y - 50, 65);
        crearPez(150, filas[0].y - 50, 65);
        crearPez(400, filas[0].y - 50, 65);
        crearPez(600, filas[0].y - 50, 65);
        ...
        crearCangrejo(850, filas[2].y - 50, -75);
        crearCangrejo(450, filas[2].y - 50, -75);
        crearCangrejo(-50, filas[1].y - 50,  75);
